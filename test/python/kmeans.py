...
cudaLib = CDLL("/home/paul/projects/kmeans-gpu/lib/libCudaKernelLibrary.so")

cdll.LoadLibrary("/home/paul/projects/kmeans-gpu/lib/libkmeans.so")
kmeansLib = CDLL("/home/paul/projects/kmeans-gpu/lib/libkmeans.so")
